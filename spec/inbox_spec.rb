...
describe 'Inbox' do
  ...
  describe "#execute_request" do
    before(:each) do
      ...
      stub_request(:post, "https://api.nylas.com/messages").
         with(:headers => {'User-Agent'=>'Nylas Ruby SDK 2.0.1 - 2.3.1', 'X-Inbox-Api-Wrapper'=>'ruby'}).
          to_return(
          :status => 200,
          :body => "foo",
    ...
    subject {@inbox.execute_request method: :post, url: "https://api.nylas.com/messages"}

    it "should execute a request with the correct headers" do
